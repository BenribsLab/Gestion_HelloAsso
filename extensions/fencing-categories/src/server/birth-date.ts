/**
 * Normalisation et contrôle de la date de naissance. Volontairement recopié dans le paquet
 * plutôt qu'emprunté au noyau : un module doit être autonome et versionné indépendamment.
 * Le noyau garde sa propre copie pour valider la fiche adhérent, ce qui reste son rôle.
 */
